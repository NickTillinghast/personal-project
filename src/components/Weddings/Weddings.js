        ...
        <div className="second-grif">
          ...
          <div className="wedding-grid-container">
            ...
            <div>
              <img
                className="wedding-grid-image"
                src="https://res.cloudinary.com/dqpatwz6c/image/upload/v1573242297/Sized%20down%20for%20personal%20project/gx8xc4qm3hua6eaobnhs.jpg"
                alt="none"
              />
            </div>
            <div>
              <img
                className="wedding-grid-image"
                src="https://res.cloudinary.com/dqpatwz6c/image/upload/v1573242293/Sized%20down%20for%20personal%20project/r7mru3bqbtkqwseah0cu.jpg"
                alt="none"
              />
            </div>
          </div>
